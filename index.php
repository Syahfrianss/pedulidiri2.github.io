              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Silakan Masukkan NIK dan Nama Lengkap Anda</p>
                  </div>

                  <form class="row g-3 needs-validation" class="user" method="post" action="proses_login.php">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Belum Register? <a href="register.php">Register Akun</a></p>
                    </div>
                  </form>
